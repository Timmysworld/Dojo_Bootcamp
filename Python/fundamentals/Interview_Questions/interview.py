...
# -ENCAPSULATION: Class Can keep members private or public 
...
# -INHERITANCE: More specificS that can be inherited to the child and child can mimic
...
# -POLYMORPHISM: Has many different forms 
