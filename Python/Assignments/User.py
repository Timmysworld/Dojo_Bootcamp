...
#NOTES:
# Each instance method created needs to have self as a parameter.
# self has all the attributes created defined in the __init__ 
...
class User:
    ...
    def bonus_points(self):
        ...
        elif self.gold_card_points > 650:
...
Anonymous_User2 = User("Tiffany","New","T.New@gmail.com",27,True,1650)
...
# Need to fix bonus points logic
