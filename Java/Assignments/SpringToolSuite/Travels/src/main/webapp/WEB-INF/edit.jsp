...
<body>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h1>Edit Expense: <c:out value="${budget.expense }"></c:out></h1>
				<a href="/dashboard" class="btn btn-primary">Dashboard</a>
				<form:form action="/expenses/edit/${budget.id}" method="put" modelAttribute="budget">
					...
					<input type="submit"  value="Edit An Expense"  class="btn-primary" />
				</form:form>
			</div>
		</div>
	</div>
